    ...
    def animals_are_going_to_die(self):
        ...
        for animal in self.animals:
            if animal.life_expectancy - animal.age < 2:
                animals_going_to_die.append(animal.name)
    ...
    def simulate(self, interval_of_time, period):
        ...
        while period >= 0:
            ...
            if animals_going_to_die != []:
                print("These animals are going to die: ", animals_going_to_die)
            dead_animals = self.animals_are_going_to_die()
            if dead_animals != []:
...
def main():
    animal1 = Animal("name", 18, "male", 87, "species", 40, "carnivore", 4, 20, 100, 200, 20)
    animal2 = Animal("animal", 18, "male", 87, "panda", 1000.0, "carnivore", 4, 20, 100, 200, 20)
    animal3 = Animal("animal3", 18, "female", 87, "panda", 100, "carnivore", 4, 20, 100, 200, 20)
    animals = [animal2]
